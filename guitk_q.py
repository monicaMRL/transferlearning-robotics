...
alpha_q = 0.05
gamma = 0.95
reward_dict = {'o': -100, 'u': -1, 'g': 100 }
max_epi = 1000
stateAction_f = open('sa_q.txt','a+')
aveRlist = list()
...
def timerHandler():
    global X, Y, stepCount,current_state, rewardSum, epi_count, stepCount, aveRlist
